...
/* RDD inline void msm_jpeg_q_init(char const *name, struct msm_jpeg_q *q_p) */
...
/* RDD inline void *msm_jpeg_q_out(struct msm_jpeg_q *q_p) */
...
/* RDD inline int msm_jpeg_q_in(struct msm_jpeg_q *q_p, void *data) */
...
/* RDD inline int msm_jpeg_q_in_buf(struct msm_jpeg_q *q_p, */
...
/* RDD inline int msm_jpeg_q_wait(struct msm_jpeg_q *q_p) */
...
/* RDD inline int msm_jpeg_q_wakeup(struct msm_jpeg_q *q_p) */
...
/* RDD inline int msm_jpeg_q_unblock(struct msm_jpeg_q *q_p) */
...
/* RDD inline void msm_jpeg_outbuf_q_cleanup(struct msm_jpeg_device *pgmn_dev, */
...
/* RDD inline void msm_jpeg_q_cleanup(struct msm_jpeg_q *q_p) */
